...
export default function SalatTime() {
  ...
  //======================API===========================
  //====================Update Salat Time=============================
  const handleUpdateNamazTime = async (id) => {
    navigate(`/admin/update-salat-time?id=${id}`)
  }
  //======================Update Salat Time===========================
                    ...
                    <tr key={key}>
                      ...
                      <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                        ...
                        >
                          ...
                          <button onClick={()=>handleUpdateNamazTime(salat.id)}>
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              width="24"
                              height="24"
                            ...
                            >
                              <path d="M21 12a9 9 0 1 1-6-8.7l1 1" />
                              <polyline points="22 4 12 14.01 9 11.01" />
                            </svg>
                          </button>
                          <button
                            onClick={() => handleDeleteSalatTime(salat.id)}

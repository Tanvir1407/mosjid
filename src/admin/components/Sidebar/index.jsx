...
import { TbCategoryPlus, TbFileInvoice } from 'react-icons/tb';
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/admin">
          <h1 className='font-bold text-[40px] text-white px-4'>MASJID</h1>
        </NavLink>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/admin/salat-time"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('salat-time') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
              ...
              <li>
                <NavLink
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('invoice-category') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
              ...
              <li>
                <NavLink
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('announcement') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <TfiWrite size={18}/>
                  Announcement
